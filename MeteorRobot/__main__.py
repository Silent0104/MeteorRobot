...
PM_START_TEXT = """
*Hello {} !*
✪ I'm an anime-theme management bot ᴡɪᴛʜ ꜱᴏᴍᴇ ꜰᴜɴ ᴇxᴛʀᴀꜱ ;)[✨](https://te.legra.ph/file/23dcf3139510088f56fce.jpg)
────────────────────────
    ...
    if query.data == "meteor_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="𝑨𝒅𝒎𝒊𝒏𝒔", callback_data="meteor_admin"),
                 ...
                 [
                    InlineKeyboardButton(text="𝑺𝒐𝒖𝒓𝒄𝒆 𝑪𝒐𝒅𝒆", url="https://github.com/Wolf2901/MeteorRobot"),
                 ],
                 [
                    InlineKeyboardButton(text="◁", callback_data="meteor_"),
                 ]
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            ...
            "\n • /𝒓𝒆𝒍𝒐𝒂𝒅 - 𝑭𝒐𝒓 𝒓𝒆𝒇𝒓𝒆𝒔𝒉𝒊𝒏𝒈 𝒕𝒉𝒆 𝒂𝒅𝒎𝒊𝒏𝒍𝒊𝒔𝒕."
            "\n • /𝒑𝒂𝒖𝒔𝒆 - 𝑻𝒐 𝒑𝒂𝒖𝒔𝒆 𝒕𝒉𝒆 𝒑𝒍𝒂𝒚𝒃𝒂𝒄𝒌."
            "\n • /𝒓𝒆𝒔𝒖𝒎𝒆 - 𝑻𝒐 𝒓𝒆𝒔𝒖𝒎𝒊𝒏𝒈 𝒕𝒉𝒆 𝒑𝒍𝒂𝒚𝒃𝒂𝒄𝒌 𝒀𝒐𝒖'𝒗𝒆 𝒑𝒂𝒖𝒔𝒆𝒅."
            "\n • /𝒔𝒌𝒊𝒑 - 𝑻𝒐 𝒔𝒌𝒊𝒑𝒑𝒊𝒏𝒈 𝒕𝒉𝒆 𝒑𝒍𝒂𝒚𝒆𝒓."
            "\n • /𝒆𝒏𝒅 - 𝑭𝒐𝒓 𝒆𝒏𝒅 𝒕𝒉𝒆 𝒑𝒍𝒂𝒚𝒃𝒂𝒄𝒌."
            "\n • /𝒎𝒖𝒔𝒊𝒄𝒑𝒍𝒂𝒚𝒆𝒓 <𝒐𝒏/𝒐𝒇𝒇> - 𝑻𝒐𝒈𝒈𝒍𝒆 𝒇𝒐𝒓 𝒕𝒖𝒓𝒏 𝑶𝑵 𝒐𝒓 𝒕𝒖𝒓𝒏 𝑶𝑭𝑭 𝒕𝒉𝒆 𝒎𝒖𝒔𝒊𝒄𝒑𝒍𝒂𝒚𝒆𝒓."
            "\n\n๏ 𝑪𝒐𝒎𝒎𝒂𝒏𝒅 𝒇𝒐𝒓 𝒂𝒍𝒍 𝒎𝒆𝒎𝒃𝒆𝒓𝒔."
            "\n • /𝒑𝒍𝒂𝒚 <𝒒𝒖𝒆𝒓𝒚 /𝒓𝒆𝒑𝒍𝒚 𝒂𝒖𝒅𝒊𝒐> - 𝑷𝒍𝒂𝒚𝒊𝒏𝒈 𝒎𝒖𝒔𝒊𝒄 𝒗𝒊𝒂 𝒀𝒐𝒖𝑻𝒖𝒃𝒆."
            "\n • /𝒑𝒍𝒂𝒚𝒍𝒊𝒔𝒕 - 𝑻𝒐 𝒑𝒍𝒂𝒚𝒊𝒏𝒈 𝒂 𝒑𝒍𝒂𝒚𝒍𝒊𝒔𝒕 𝒐𝒇 𝒈𝒓𝒐𝒖𝒑𝒔 𝒐𝒓 𝒚𝒐𝒖𝒓 𝒑𝒆𝒓𝒔𝒐𝒏𝒂𝒍 𝒑𝒍𝒂𝒚𝒍𝒊𝒔𝒕",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def get_help(update: Update, context: CallbackContext):
    ...
    if chat.type != chat.PRIVATE:
        if len(args) >= 2 and any(args[1].lower() == x for x in HELPABLE):
            module = args[1].lower()
            update.effective_message.reply_text(
                f" 𝑪𝒐𝒏𝒕𝒂𝒄𝒕 𝒎𝒆 𝒊𝒏 𝑷𝑴 𝒕𝒐 𝒈𝒆𝒕 𝑯𝒆𝒍𝒑 𝒐𝒇  {module.capitalize()}",
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
